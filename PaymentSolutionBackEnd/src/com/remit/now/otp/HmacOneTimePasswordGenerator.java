...
/**
 * <p>Generates HMAC-based one-time passwords (HOTP) </p>
 *
...
public class HmacOneTimePasswordGenerator {
     ...
     * ({@value com.omnia.pie.otp.HmacOneTimePasswordGenerator#DEFAULT_PASSWORD_LENGTH} digits).
     *
     ...
     * HOTP only allows for {@value com.omnia.pie.otp.HmacOneTimePasswordGenerator#HOTP_HMAC_ALGORITHM}, but derived
